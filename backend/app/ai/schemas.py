...
class JobExtraction(BaseModel):
    ...
    recruiter: Optional[str] = Field(None, description="The name of the recruiter or contact person.")
    job_title: Optional[str] = Field(None, description="The job title.")
    description: Optional[str] = Field(None, description="A brief summary of the job description.")
    compensation: Optional[str] = Field(None, description="The offered compensation, salary, or pay rate.")
    location: Optional[str] = Field(None, description="The job location (remote or physical).")
    application_url: Optional[str] = Field(None, description="The URL where the applicant is supposed to apply or contact.")
    recruiter_email: Optional[str] = Field(None, description="The email address provided for contact.")
    recruiter_phone: Optional[str] = Field(None, description="The phone number provided for contact.")
