  ...
  return (
    <div className="min-h-screen bg-background text-text p-4 sm:p-8">
      <div className="max-w-4xl mx-auto space-y-8 animate-pulse">
        ...
        <div className="panel border border-border bg-surface p-6">
          <div className="flex flex-col lg:flex-row items-stretch gap-6">
            <div className="lg:w-5/12 flex flex-col items-center justify-center p-6 bg-surface-raised/20 rounded">
              <div className="h-32 w-32 rounded-full border-4 border-border border-t-brand-500/40 animate-spin" />
            ...
            <div className="lg:w-7/12 flex flex-col justify-between space-y-4">
              ...
              <div className="h-16 bg-surface-raised/40 rounded border border-border p-3" />
            </div>
          </div>
        </div>

        {/* 4-Part Verification Matrix Skeleton */}
        <div className="panel p-6 border border-border bg-surface space-y-4">
          <div className="h-4 w-56 bg-surface-elevated rounded" />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="p-4 rounded border border-border bg-surface-raised/20 space-y-3">
        ...
        <div className="panel p-6 border border-border bg-surface space-y-4">
          ...
          <div className="space-y-3">
            {[1, 2].map((i) => (
              <div key={i} className="p-4 rounded border border-border bg-surface-raised/20 space-y-2.5">
                <div className="flex justify-between">
                  <div className="h-4 w-36 bg-surface-elevated rounded" />
                  <div className="h-4 w-16 bg-surface-elevated rounded" />
                </div>
                <div className="h-12 bg-surface/50 rounded border border-border/40" />
