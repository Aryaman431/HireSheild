  ...
  return (
    <div className="flex-1 flex items-center justify-center min-h-[calc(100vh-3.5rem)] py-12 px-4">
      <div className="panel max-w-md w-full p-8 border border-border text-center space-y-6">
        ...
        <div>
          <span className="tech-label text-text-muted mb-1">AUTHENTICATION SUBSYSTEM</span>
          ...
          <p className="text-xs font-mono text-text-muted mt-2 leading-relaxed">
            HireShield is running in demo mode. All deep threat analysis tools, entity verification checks, and historical databases are unlocked without signing in.
          </p>
        </div>
